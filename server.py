...
Description: Server that decodes embedded payloads from DNS queries and responds with encoded DNS answers.
...
if __name__ == "__main__":  
    parser = argparse.ArgumentParser(description="DNS Analyzer: server script")
