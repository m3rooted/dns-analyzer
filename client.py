...
Description: Client for generating DNS queries carrying encoded payloads (simulation/lab use).
...
if __name__ == "__main__":
    ...
    parser = argparse.ArgumentParser(description="DNS Analyzer: client script")
    ...
    parser.add_argument('-s', '--scramble', dest='scramble', type=int, nargs='+',
                        help='Scrambles outgoing traffic passing through the DNS channel.\n'+
                            'You need to specify an offset, e.g. (3, 11)')

    parser.add_argument('-a', '--aes', dest='aes_key', type=str,
                        help='Encrypts with AES outgoing traffic passing through the DNS channel.\n'+
